...
buttonEls.forEach(el => el.addEventListener('click', handleClick));
...
function showMoreText(card) {
    ...
    let myText = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam aliquam est sagittis, commodo augue et, scelerisque nunc. Nulla euismod bibendum consectetur.'
    ...
    divEl.textContent = myText;
    card.productName.insertAdjacentElement('afterend', divEl);
